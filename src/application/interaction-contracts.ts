...
export type ReferenceOwnPreference = { referenceSongId: string; category: PreferenceProfileCategory; score: number | null; limit: number; aggregatePreferenceScore: number };
