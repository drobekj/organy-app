...
ALTER TABLE "protected_account_actor_links" ADD CONSTRAINT "protected_account_actor_links_auth_user_id_auth_users_id_fk" FOREIGN KEY ("auth_user_id") REFERENCES "public"."auth_users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "protected_account_actor_links" ADD CONSTRAINT "protected_account_actor_links_app_user_id_app_users_id_fk" FOREIGN KEY ("app_user_id") REFERENCES "public"."app_users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "auth_users_username_idx" ON "auth_users" USING btree ("username");--> statement-breakpoint
CREATE INDEX "auth_verifications_identifier_idx" ON "auth_verifications" USING btree ("identifier");--> statement-breakpoint
CREATE UNIQUE INDEX "protected_account_actor_links_app_user_idx" ON "protected_account_actor_links" USING btree ("app_user_id");--> statement-breakpoint
