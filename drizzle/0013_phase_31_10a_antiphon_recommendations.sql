CREATE TABLE "reference_antiphon_recommendations" (
	"reference_antiphon_id" text PRIMARY KEY NOT NULL,
	"reference_song_id" text NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL
);
--> statement-breakpoint
ALTER TABLE "reference_antiphon_recommendations" ADD CONSTRAINT "reference_antiphon_recommendations_antiphon_fk" FOREIGN KEY ("reference_antiphon_id") REFERENCES "public"."reference_antiphons"("id") ON DELETE CASCADE ON UPDATE NO ACTION;
--> statement-breakpoint
