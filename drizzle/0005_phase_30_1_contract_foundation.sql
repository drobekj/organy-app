...
CREATE TABLE "melody_non_repetition_rules" ("id" text PRIMARY KEY NOT NULL,"class_id" text NOT NULL REFERENCES "melody_equivalence_classes"("id") ON DELETE cascade,"days_before" integer DEFAULT 0 NOT NULL,"days_after" integer DEFAULT 0 NOT NULL,"synthetic" boolean DEFAULT false NOT NULL);
