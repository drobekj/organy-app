...
const working: PersistedPlanningSet = { id: "set-1", status: "working", language: "czech", serviceContext: baseContext, rows: [{ note: "Prelude" }], lastChangedBy: "Editor One" };
const final: PersistedPlanningSet = { id: "set-2", status: "final", language: "polish", serviceContext: { ...baseContext, language: "polish" }, rows: [{ note: "Song" }, { note: "Postlude" }], lastChangedBy: "Editor Two" };
...
assert.match(formatPlanningSetSummary({ ...working, lastChangedBy: undefined }), /changed by —/);
