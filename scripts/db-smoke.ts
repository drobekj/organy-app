...
async function main() {
  ...
  try {
    ...
    const saved = await repository.saveWorkingSet(initialWorkingSet, { serviceDate: "2026-07-09", serviceTime: "09:00", language: "czech", priest: { displayName: "Smoke Priest" }, organist: { displayName: "Smoke Organist" } });
    ...
    const updated = await repository.saveWorkingSet(updatedWorkingSet, { ...{ serviceDate: "2026-07-09", serviceTime: "09:00", language: "czech", priest: { displayName: "Smoke Priest" }, organist: { displayName: "Smoke Organist" } }, language: "mixed" }, saved.id);
