...
const LOG_PATH = resolve(process.cwd(), "phase-31-11-human.log");
const PASS = "Phase 31.11 authoritative Service Context antiphon: HUMAN PASS";
const FAIL = "Phase 31.11 authoritative Service Context antiphon: HUMAN FAIL";
...
async function main() {
  await writeFile(LOG_PATH, "Phase 31.11 local browser checkpoint\n", "utf8");
